<!--
  THESIS: Search visitors need a stable Assam flood information desk explaining
  what the river numbers mean and where they come from.
  MODE: Preserve the River Observatory visual system. Crawlable public-service
  content that stands beside the live map rather than in front of it.

  This page used to sit at `/` and bounce real visitors to the map, which made
  the first thing anyone saw a flash of the wrong page. The map is the site's
  front door now. This is the explanatory page it links to.
-->
<script>
  import {
    faqItems,
...
<article class="search-landing">
  ...
  <section class="source-section">
    ...
    <aside>
      ...
      <a href="/">Search for a place in Assam</a>
    </aside>
  </section>
